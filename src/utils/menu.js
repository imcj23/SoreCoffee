...
export const menus = [
  ...
  },
  {
    ...
    name: "Chocolate",
    category: "Non-Coffee",
    description: "Coklat berkualitas yang memberikan sensasi manis dan creamy disetiap tegukan",
    ingredients:['Bubuk Coklat','Susu full Cream', 'Gula'],
    calories: 220,
    rating: 4.9,
    tags: ["Signature", "Trending"],
    price: "Rp.15.000",
  ...
  },
  {
    ...
    category: "Non-Coffee",
    description: "Bubuk matcha pilihan yang memberikan rasa creamy",
    ingredients:['Bubuk Matcha', 'Susu Full Cream'],
    calories: 150,
    rating: 4.9,
    tags: ["Signature", "Trending"],
    price: "Rp.15.000",
  ...
  },
  {
    ...
    name: "Pink Panther",
    category: "Non-Coffee",
    description: "Perpaduan rasa manis dan sedikit asam, dipadukan dengan susu creamy",
    ingredients:'',
    calories: 180,
    rating: 4.9,
    tags: ["Signature", "Trending"],
