  ...
  const faqItems = [
    {
      ...
      answer: "Kami buka setiap hari dari pukul 08:00 hingga 22:00 WIB.",
    ...
    },
    {
      ...
      answer:
        "Tentu! Kami menyediakan pembayaran melalui QRIS.",
        ...
        <div className="relative bg-linear-to-r from-amber-800 via-amber-700 to-amber-900 text-white py-12 md:py-16 lg:py-20 px-4 overflow-hidden">
          ...
          <div className="relative max-w-6xl mx-auto text-center z-10 px-2">
            ...
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl opacity-95 max-w-2xl sm:max-w-3xl mx-auto font-light mb-4 md:mb-6">
              Ada pertanyaan, saran, atau ingin berkolaborasi? Kami siap
        ...
        <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-8 sm:py-10 md:py-12">
          <div className="text-center mb-8 sm:mb-10 md:mb-12">
            ...
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-gray-800 mb-3 sm:mb-4 px-2">
              Temukan Cara untuk{" "}
              <span className="text-amber-600">Menghubungi Kami</span>
            </h2>
            <p className="text-gray-600 max-w-xl sm:max-w-2xl mx-auto text-sm sm:text-base md:text-lg px-2">
              Pilih metode kontak yang paling nyaman untuk Anda. Kami selalu
              siap mendengarkan!
            </p>
          </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6 md:gap-8 mb-12 md:mb-16">
            <div className="lg:w-1/2 space-y-6 md:space-y-8">
              <div className="bg-linear-to-br from-white to-amber-50 rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl p-4 sm:p-6 md:p-8 border border-amber-100">
                ...
                <div
                  ...
                  className="group relative  rounded-xl sm:rounded-2xl p-4 sm:p-6 border-2 border-green-200 hover:border-green-400 transition-all duration-300 cursor-pointer transform hover:-translate-y-0.5 sm:hover:-translate-y-1 hover:shadow-lg sm:hover:shadow-xl mb-4 sm:mb-6 overflow-hidden"
                >
                  <div className="absolute top-0 right-0 w-16 h-16 sm:w-20 sm:h-20 md:w-24 md:h-24 rounded-full -translate-y-4 translate-x-4 sm:-translate-y-6 sm:translate-x-6"></div>
                  <div className="relative flex items-center">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-center mb-1 sm:mb-2 gap-1 sm:gap-3">
                        ...
                        <span className="bg-green-100 text-green-800 text-xs font-semibold px-2 py-0.5 sm:px-3 sm:py-1 rounded-full w-fit">
                          Fast Response
                        </span>
                      </div>
                      <p className="text-gray-700 font-medium text-sm sm:text-base md:text-lg truncate">
                        {whatsappNumber}
                      </p>
                ...
                <div
                  ...
                  className="group relative rounded-xl sm:rounded-2xl p-4 sm:p-6 border-2 border-pink-200 hover:border-pink-400 transition-all duration-300 cursor-pointer transform hover:-translate-y-0.5 sm:hover:-translate-y-1 hover:shadow-lg sm:hover:shadow-xl mb-4 sm:mb-6 overflow-hidden"
                >
                  <div className="absolute top-0 left-0 w-12 h-12 sm:w-16 sm:h-16 md:w-20 md:h-20  rounded-full -translate-x-3 -translate-y-3 sm:-translate-x-4 sm:-translate-y-4 md:-translate-x-6 md:-translate-y-6"></div>
                  <div className="relative flex items-center">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-center mb-1 sm:mb-2 gap-1 sm:gap-3">
                        ...
                        <span className="bg-pink-100 text-pink-800 text-xs font-semibold px-2 py-0.5 sm:px-3 sm:py-1 rounded-full w-fit">
                          Daily Updates
                        </span>
                      </div>
                      <p className="text-gray-700 font-medium text-sm sm:text-base md:text-lg truncate">
                      ...
                      <p className="text-gray-500 mt-1 sm:mt-2 text-xs sm:text-sm">
                        Lihat menu terbaru, promo, dan lokasi hari ini
                      </p>
                    </div>
                ...
                <div
                  ...
                  className="group relative  rounded-xl sm:rounded-2xl p-4 sm:p-6 border-2 border-blue-200 hover:border-blue-400 transition-all duration-300 cursor-pointer transform hover:-translate-y-0.5 sm:hover:-translate-y-1 hover:shadow-lg sm:hover:shadow-xl overflow-hidden"
                >
                  <div className="relative flex items-center">
                    <div className="bg-black p-2.5 sm:p-3 md:p-4 rounded-xl sm:rounded-2xl mr-3 sm:mr-4 md:mr-6 shadow-md sm:shadow-lg group-hover:scale-105 sm:group-hover:scale-110 transition-transform duration-300">
                    ...
                    <div className="flex-1 min-w-0">
                      <div className="flex flex-col sm:flex-row sm:items-center mb-1 sm:mb-2 gap-1 sm:gap-3">
                        ...
                        <span className="bg-blue-100 text-blue-800 text-xs font-semibold px-2 py-0.5 sm:px-3 sm:py-1 rounded-full w-fit">
                          Fun Content
                        </span>
                      </div>
                      <p className="text-gray-700 font-medium text-sm sm:text-base md:text-lg truncate">
                      ...
                      <p className="text-gray-500 mt-1 sm:mt-2 text-xs sm:text-sm">
                        Tonton video menarik seputar kopi dan cerita SoreCoffee
                      </p>
                    </div>
              ...
              <div className="bg-linear-to-r from-amber-600 to-orange-600 text-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl p-4 sm:p-6 md:p-8">
                <div className="flex gap-4 sm:flex-row sm:items-start mb-4 sm:mb-6">
                  ...
                  <div>
                    ...
                    <p className="opacity-90 text-sm sm:text-base">
                      Temukan kami di berbagai spot strategis di Tanjungpinang
                    </p>
                  </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4 md:gap-6">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5">
                    ...
                    <p className="text-amber-50 text-sm">08:00 - 22:00 WIB</p>
                  </div>
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg sm:rounded-xl p-3 sm:p-4 md:p-5">
                    <div className="flex items-center mb-2 sm:mb-3">
                    ...
                    <p className="text-amber-50 text-sm">
                      Cek Instagram untuk update harian
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="lg:w-1/2 w-full px-3 sm:px-0 space-y-5 sm:space-y-6 md:space-y-8">
              <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg sm:shadow-xl p-4 sm:p-6 md:p-8 border border-gray-100">
                <div className="flex  sm:flex-row sm:items-center gap-3 sm:gap-4 mb-6 md:mb-8">
                  <div className="bg-linear-to-r from-amber-500 to-orange-500 p-2.5 sm:p-3 rounded-lg sm:rounded-xl w-11 h-11 sm:w-auto sm:h-auto flex items-center justify-center">
                    <FaQuestionCircle className="w-5 h-5 sm:w-8 sm:h-8 text-white" />
                  </div>
                  <div>
                    ...
                    >
                      ...
                      >
                        <div className="flex items-center flex-1 min-w-0">
                          <div
                            className={`p-2 sm:p-3 rounded-lg sm:rounded-xl mr-2 sm:mr-3 md:mr-4 ${
                              activeFAQ === item.id
                          ...
                          <span className="font-semibold text-gray-800 text-sm sm:text-base md:text-lg pr-2 break-words">
                            {item.question}
                          </span>
                        </div>
                      ...
                      {activeFAQ === item.id && (
                        <div className="px-3 sm:px-4 md:px-6 pb-3 sm:pb-4 md:pb-6 pt-1 sm:pt-2">
                          {/* Kurangi padding kiri agar tidak terlalu masuk di 360px */}
                          <div className="pl-0 sm:pl-12 md:pl-16">
                            <p className="text-gray-700 bg-white p-3 sm:p-4 rounded-lg sm:rounded-xl border border-gray-200 shadow-sm text-sm sm:text-base leading-relaxed">
                              {item.answer}
                            </p>
                          </div>
                        </div>
          ...
          <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl bg-linear-to-r from-emerald-600 via-green-600 to-emerald-700 text-white p-6 sm:p-8 md:p-10 lg:p-12 text-center shadow-xl sm:shadow-2xl">
            ...
            <div className="relative z-10">
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl opacity-95 max-w-xl sm:max-w-2xl mx-auto mb-4 sm:mb-6 md:mb-8">
                Tim SoreCoffee siap membantu Anda dengan pertanyaan, pemesanan,
                atau sekadar ngobrol tentang kopi!
              </p>
              <button
                onClick={handleWhatsAppClick}
              ...
              >
                ...
                Mulai Chat Sekarang
                <svg
                  className="ml-2 sm:ml-3 w-3 h-3 sm:w-4 sm:h-4 md:w-5 md:h-5 group-hover:translate-x-1 sm:group-hover:translate-x-2 transition-transform duration-300"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
              ...
              <p className="mt-4 sm:mt-6 text-emerald-200 text-xs sm:text-sm">
                ⚡ Respon dalam hitungan menit • 🎁 Special offer untuk chat
                pertama
              </p>
            </div>
          </div>
