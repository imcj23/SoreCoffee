      ...
      <section className="py-8 md:py-12 bg-linear-to-b from-white to-amber-50/30 min-h-screen">
        <div className="container mx-auto px-3 md:px-4 max-w-7xl">
          <div className="sticky top-20 md:top-20 z-30 bg-white/90 backdrop-blur-sm rounded-xl md:rounded-2xl shadow-md md:shadow-lg p-1.5 md:p-2 mb-6 md:mb-10 border border-amber-100">
            <div className="flex flex-wrap justify-between md:justify-center gap-1 md:gap-4">
              <button
                onClick={() => setActiveCategory("all")}
                className={`flex items-center gap-1 px-2.5 py-1.5 rounded-lg text-xs md:text-sm font-medium whitespace-nowrap transition-all duration-300 ${
                  activeCategory === "all"
                    ? "bg-linear-to-r from-amber-600 to-orange-600 text-white shadow-md shadow-amber-200"
              ...
              >
                <FaCoffee size={12} />
                <span>Coffee</span>
                <span className="bg-amber-100 text-amber-800 text-[10px] md:text-xs px-1.5 py-0.5 rounded-full">
                  {coffeeItems.length}
                </span>
              </button>
              ...
              >
                ...
                <span className="bg-green-100 text-green-800 text-[10px] md:text-xs px-1.5 py-0.5 rounded-full">
                  ...
                  <div className="flex items-center justify-between pt-3 md:pt-4 border-t border-amber-100 ">
                    <div className="flex items-center gap-3 md:gap-4 text-xs md:text-sm text-gray-500">
                      <div className="flex items-center gap-1 md:gap-2">
                        <FaFireFlameCurved
                          className="text-orange-500 md:size-4 mr-1"
                          size={12}
                        />
                    ...
                    <button
                      ...
                      className="group relative px-3 sm:px-5 md:px-6 py-1.5 sm:py-2.5 md:py-3 bg-linear-to-r from-amber-600 to-orange-600 text-white font-medium md:font-semibold rounded-full transition-all duration-300 hover:shadow-md md:hover:shadow-lg hover:shadow-amber-200 hover:-translate-y-0.5 overflow-hidden w-auto"
                    >
                      <span className="relative z-10 flex items-center justify-center gap-1 sm:gap-2 text-xs sm:text-sm md:text-base whitespace-nowrap">
                        Detail
                        <FaLongArrowAltRight
                          className="ml-0.5 sm:ml-1 transition-transform duration-300 group-hover:translate-x-1"
                          size={10}
                        />
                      </span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-8">
              <div className="bg-linear-to-br from-white to-amber-50 p-4 md:p-8 rounded-2xl md:rounded-3xl border border-amber-100 shadow-lg hover:shadow-xl transition-shadow duration-300">
                ...
                <p className="text-gray-600 text-sm md:text-base text-center md:text-left">
                  Dipilih dengan standar tinggi, roasted to perfection
                  menciptakan keseimbangan rasa, aroma, dan kehangatan dalam
                  setiap sajian.
                </p>
              </div>
